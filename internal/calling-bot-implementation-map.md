...
- The active agent opening rule is startup-safe: the first audible message is the static text `Hello` and contains no dynamic placeholders. The first substantive response after the contact answers should identify Alexander Gulin and the represented Company/Individual; Richmond Blackwood Limited is not mentioned before the represented subject is clear. For company calls, Richmond Blackwood Limited is introduced after that as the company secretary, which is the representative position; PoA/Vollmacht is a fallback only when the call is marked as requiring it or the authority insists.
...
- Agent language: English default.
- LLM: `claude-haiku-4-5`.
- First message: `Hello, my name is Alexander Gulin. I am calling about an administrative matter for a client, and I would like to make sure I am speaking with the right department.`
...
- Prompt now includes pronunciation rules to spell common abbreviations letter-by-letter, including V-A-T, P-O-A, U-B-O, R-B-O, E-O-R-I, P-P-S-N, U-T-R, T-A-I-N, R-O-S, H-M-R-C, C-R-O, I-D, and R-B.
- Prompt now includes `Identifier Pronunciation - Prompt Controlled` and `Slow Number Delivery - Hard Rule`: n8n sends raw identifiers only; the agent must preserve exact raw values while saying numbers, registration numbers, tax references, phone numbers, and alphanumeric strings much, much slower than normal speech. It should announce important identifiers with "I'll say that slowly", use clear pauses and breaks between every chunk, group long numeric strings into two or three digits at most, spell letters one by one, and repeat even slower if asked. Prompt examples include `DE345068258` as `D ... E ... pause ... three ... four ... five ... pause ... zero ... six ... eight ... pause ... two ... five ... eight`, `3989866OH` as `three ... nine ... eight ... pause ... nine ... eight ... six ... six ... pause ... O ... H`, and `IE6388047V` as `I ... E ... pause ... six ... three ... eight ... eight ... zero ... four ... seven ... pause ... V`.
