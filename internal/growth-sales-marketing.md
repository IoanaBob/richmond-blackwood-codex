...
- LinkedIn copy should bring up US-vs-Germany differences when relevant: tax/admin as one shared human contrast, plus one second contrast tied to the prospect's topic, such as privacy, sales cycles, procurement, hiring, fundraising, fintech regulation, cloud/data constraints, consumer behavior, or developer adoption. Avoid self-labels like "as a fellow tech founder" or "I am a tech founder too."
