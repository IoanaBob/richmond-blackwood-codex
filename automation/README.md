...
- `automation/elevenlabs/rb-calls/patch-agent-representation-opening.mjs`: patches the RB Call Bot opening identity, first message, caller/representative placeholders, and PoA/Vollmacht fallback rules.
