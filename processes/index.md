...
Status: provisional.
Source: local repo and neutral operating process structure.
Imported: 2026-05-05.
Review: confirm which process pages should be mirrored into RB Internal Knowledge Base after review.

This directory is the source-controlled process and SOP mirror for Richmond Blackwood.
...
- `accounting-team-updates-triage.md` - packet-gated weekday Accounting Team Updates blocker/action routing into Notion Tasks, source-page write-back, and approved Slack closeout.
...
When a workflow changes, update the matching process file, relevant skill, memory, source/import logs, and Notion backup page if the destination is clear.
