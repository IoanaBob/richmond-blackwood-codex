...
Imported: 2026-06-06.
Review: Confirm deadline calculation, automation expectations, and whether every annual VAT filing row should be created by year-end or only when annual VAT work starts.
...
- Do not mark the task complete while placeholder rows still need due dates, submissions, payment/refund review, or authority confirmation.
