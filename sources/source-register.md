...
| Source | Scope | Import status |
| --- | --- | --- |
| Codex AGL board-doc runs on 2026-05-25 | Client BOD workflow: meeting folder first, agenda in folder, minutes from transcript/extracts, execution PDF, signed-copy upload, folder verification, and memory/source registration | Routed to `skills/rb-client-board-docs/SKILL.md`, `clients/Companies/AGL/drive-locations.md`, `clients/Companies/AGL/source-register.md`, and memory; provisional pending repeated use on another client. |
