...
AGL company Finanzamt May 2026 sources are routed to `clients/Companies/AGL/source-register.md`. The 2026-05-25 follow-up used the live user-reviewed ELSTER annual VAT draft, local source PDFs in Downloads, Notion payroll task `https://www.notion.so/35ce4130131481fbb755c6bce3ff7ef2`, Google Drive source/correspondence files, and the local staging packet `/private/tmp/agl_finanzamt_ready_packet/`. After user approval, the 2024 Umsatzsteuererklaerung was submitted in ELSTER with Transferticket `ep1454t90i8mmb5zp5wtk182ewbfh5wq`; the user-saved return/review PDF was uploaded to Drive at `https://drive.google.com/file/d/1aFHjF8spGtE1g_tYavgmG2rO9-jYsTP2/view?usp=drivesdk` and recorded in Notion comments `36be4130-1314-81ca-9006-001dfcf9a622` and `36be4130-1314-81d9-b2eb-001d8a850ea2`. The four May 2026 incoming Finanzamt letters/scans, Q1-Q4 2024 UStVA protocols, and final E-Bilanz `.xlsx` workpaper were also uploaded to the existing AGL Drive folders and are indexed in `clients/Companies/AGL/drive-locations.md`. On 2026-05-26, a user-approved ELSTER holding message was submitted with ticket `ep1462eym8u2br1mdekveum80xchf83n`, and a formal USt 2024 Einspruch/AdV was submitted with ticket `ep1465aipg984922yz1tff6f2r95kktx`; Notion task comment `36be4130-1314-8185-8f74-001d5e870a14` and Communications records `https://www.notion.so/36be413013148131a995ca7dc0decfcf` / `https://www.notion.so/36be413013148176af0bee390cdde567` record the live writes. The repo stores source pointers and provisional readings, not ELSTER credentials or raw private evidence files.
