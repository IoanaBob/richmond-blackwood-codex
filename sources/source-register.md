...
## Client Board Document Workflow Sources

| Source | Scope | Import status |
| --- | --- | --- |
| Codex AGL board-doc runs on 2026-05-25 and PR #47 review fix on 2026-06-02 | Client BOD workflow: packet-gated meeting setup, agenda/folder creation, Calendar check/proposed update, minutes review, signature execution, signed-copy intake/storage, folder verification, and memory/source registration | Routed to `skills/rb-client-board-docs/SKILL.md`, `skills/rb-client-board-docs/references/`, `clients/Companies/AGL/drive-locations.md`, `clients/Companies/AGL/source-register.md`, and memory; provisional pending repeated use on another client. |
