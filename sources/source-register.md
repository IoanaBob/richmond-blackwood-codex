...
| Source | Scope | Status |
| --- | --- | --- |
| Codex thread instruction, 2026-06-01 | Build a Germany growth strategy as separate multi-stage channel skills with one master multi-stage skill; the first audience target is Americans in Germany / Americans relocating to Germany; channels include LinkedIn direct connects/messages, Facebook group partnerships/sponsorships, relocation-agent partnerships, and Reddit presence; the persona is always Ioana and sends must block unless Ioana is logged in; user then requested Notion databases and a central task/project location; user later deleted the separate outreach database and instructed growth outreach to use canonical Communications; user later replaced the dedicated growth partnership source with existing Business Partners; user later clarified the growth databases should live in the Richmond Blackwood teamspace and the project should be tasks only | Routed to Notion task project `https://www.notion.so/372e41301314817bb344fbb0a11d9ae8`, RB Client Databases `https://www.notion.so/f272baa16c3b45069cbd896624e04b5c`, existing Business Partners, canonical Communications, linked Tasks rows, `internal/growth-sales-marketing.md`, `sources/notion-backups.md`, `sources/import-log.md`, `memory/tasks.md`, and repo-local Germany growth skills; daily automation remains open |
