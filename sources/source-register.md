...
EVG company sources are routed to `clients/Companies/EVG/source-register.md`. The 2026-06-08 import used the Notion company record `https://www.notion.so/15fe4130131480079a95fd029aef3511`, primary project `https://app.notion.com/p/32fe413013148089b1ffce315e1eb38f`, operational project `https://app.notion.com/p/372e4130131480e082dbe27d971a51d3`, linked Ioana/Eran role records, EIP group relation, active Luiza/EVG loan contract and invoices, filing registrations and filing rows, EVG process pages, Techpacito bond subscription/cashflow rows, M&A Arts and Phillips active issue rows, and Drive search/list-folder results. Likely canonical Drive folder is `08. Everguard Research` under internal companies (`https://drive.google.com/drive/folders/1DTsSxkmjpdA-ZykGCr88nX8iHp82W2hj`). No live Notion, Drive, Gmail, Slack, or WhatsApp writes were made, and no WhatsApp route was used or stored.
