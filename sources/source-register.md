...
| Source | Scope | Status |
| --- | --- | --- |
| Codex thread instruction and user-provided local PDFs, 2026-05-26 | CLV/COHEN LIBERTAS VISION LIMITED Finanzamt fuer Koerperschaften III Lohnsteuer `Mrz.26` reminder and Wise payment proof response; raw PDFs kept out of git, combined packet saved to CLV Drive | Routed to `clients/Companies/CLV/`, CLV Drive Correspondence/Outgoing, and new `rb-finanzamt-payment-proof-response` skill |
