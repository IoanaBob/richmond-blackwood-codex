...
| `everguard-research-codex` | Neutral Codex operating infrastructure, npm helper patterns, memory/process/skill standards | Neutral infrastructure ported; company-specific workflows excluded |
