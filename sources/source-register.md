...
| Codex thread instruction/answers, 2026-05-19 | NACV/NA CAPITAL VENTURES LIMITED context import; Andrei Nasonov individual routing; user clarified Andrei was/is RB's first client, 2024 personal tax is free, 2025 onward should be billed normally, filings are joint because he is married, 2024 personal tax is pending but RB wants to file 2024 and 2025 together, NACV had registration/prepayment issues, VAT was deregistered in October with appeal submitted and no response, and 2024/2025 company taxes were filed while prepayment notices/amounts remain open | Routed to `clients/Companies/NACV/`, `clients/Individuals/Andrei Nasonov/`, source logs, and memory; no live Notion records were modified |
