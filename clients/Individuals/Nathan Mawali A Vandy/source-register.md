...
| Google Drive solvency evidence folder | 2026-05-05 | Financial Summary, bank statements, crypto holdings, identity, tenancy, employment, and shareholding evidence downloaded through the linked VUN export package. |
...
| VUN company folder | 2026-05-05 | Company relationship and current backup package pointers from `../../Companies/VUN/`. |

## Local Evidence Pointer

Actual exported/downloaded individual evidence from the current VUN pass is under:
