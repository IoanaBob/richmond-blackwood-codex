...
Status: provisional.
Source: Drive 2024 tax package; Drive notes for Steuerberater; WhatsApp chat `Brivio, Claudio | Richmond Blackwood`.
Imported: 2026-05-13.
Review: This records tax-filing evidence pointers only. Confirm legal ownership and filing treatment before using these values in a return.
...
Status: provisional.
Source: Drive note `06_kapitalanlagen.md`; Drive folder `07_Investments`.
Imported: 2026-05-13.
Review: Verify the N26 file before treating capital-income forms as not required.

The Drive notes state no 2024 securities deposits, foreign brokers, or crypto transactions, and say Anlage KAP / KAP-INV / KAP-AUS is not required. However, `N26-tax-statement-2024.pdf` is in the investment folder and needs content review/reclassification.
