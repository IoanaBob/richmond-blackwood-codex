...
| Confirm intended ELSTER filing target before data entry. | User instruction on 2026-05-22; live Notion 2024 and 2025 Personal Tax Filing records | 2024 is marked `Filed` with a filed date and submission attachment; 2025 is open but the filing task says filing should wait for payroll, SteuerGo/LStB, broker/tax statement, direct-payment, and expense confirmation checks. |
