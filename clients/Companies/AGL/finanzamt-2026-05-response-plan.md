...
| Annual VAT live ELSTER draft | User-opened Mein ELSTER session on 2026-05-25 | 2024 Umsatzsteuererklaerung is prepared and validated with no errors at the final `Absenden` screen, with Stralauer Platz 35 address, foreign-entrepreneur/Anlage UN markers, and EUR 0.00 final VAT/refund. It has not been submitted yet because the user is reviewing the final screen. |
| Mahnung / account statement | `SD79-26003 AGILE LINCS LIMITED 信件3.pdf` and `SD79-26003 AGILE LINCS LIMITED 信件4.pdf` in the user Downloads folder | Scanned account statement dated 2026-05-19 shows an enforcement-facing balance of EUR 5,781.25 and visible Lohnsteuer credits for May 2024 through April 2025. The local USt assessment behind the VAT part was found; KSt/GewSt/soli bases still need review. |
...
| Local working packet | `/private/tmp/agl_finanzamt_ready_packet/` | Local staging packet created on 2026-05-25 while the user reviewed the annual VAT final screen. It separates VAT, E-Bilanz, Mahnung, payroll, and review-only attachments. This is a working folder only, not the Drive evidence archive. |
...
| 2 | File the 2024 Umsatzsteuererklaerung electronically, likely as zero if the books confirm no German VATable output/input VAT. | ELSTER / AGL certificate or filing software. | Prepared in Mein ELSTER and validated with no errors at the final `Absenden` screen. Not submitted yet while the user reviews. | Submit after user approval, save/download the protocol, and use it to request amendment/processing of the 2024 USt assessment. |
...
| 4 | Respond to the 2026-05-19 Mahnung before enforcement pressure escalates. | ELSTER form/message, ideally with the annual VAT filing and E-Bilanz timing referenced. | Account statement shows EUR 5,781.25 total. The USt component is now traced to a 2026-03-23 USt Bescheid assessing EUR 5,200.00 plus EUR 75.00 Verspaetungszuschlag; KSt/GewSt/soli bases still need source review. | Ask for collection/enforcement pause while the annual VAT and E-Bilanz are processed; request any still-missing Bescheide/account allocation details. |
...
- Annual VAT: quarterly UStVA protocols exist, but the annual 2024 Umsatzsteuererklaerung is still requested. The annual VAT return is prepared in Mein ELSTER at the final review screen as EUR 0.00, with no validation errors, and is awaiting user approval for `Absenden`.
...
- Mahnung: the EUR 5,781.25 balance appears connected at least partly to the 2026-03-23 USt 2024 assessment for EUR 5,200.00 plus EUR 75.00 late-filing surcharge. Do not treat the Mahnung alone as proof that the tax is finally due. After annual VAT submission, ask for processing/amendment and collection pause while missing filings are cured; retrieve any remaining KSt/GewSt/soli assessment basis.
...
| --- | --- | --- |
| Annual VAT final submission pending user approval | The 2024 annual return is prepared and validated, but the user is reviewing the ELSTER final screen. | Do not touch/navigate away from the ELSTER page while review is pending. After approval, submit, save the protocol, and record the transfer ticket. |
