...
Imported: 2026-05-25.
Review: Annual VAT and payroll-tax returns listed below were submitted only after user approval. Any further E-Bilanz transmission, Finanzamt message, Einspruch, Aussetzung der Vollziehung request, payroll evidence submission, or payment decision still needs operator/accountant review. The ELSTER certificate/password are live credentials and are not stored here.
