...
Status: provisional.
Source: Google Drive search/list/metadata on 2026-05-13.
Imported: 2026-05-13.
Review: Canonical Drive folder found under the external client root. Do not move or reorganize files without a separate user instruction.

Client Drive folder: `04. Agile Lincs Limited (AGL)` at `https://drive.google.com/drive/folders/1QnVBrQ0lgDe8UVqZyW9B7zdBMCC_LgAE`.
Parent folder: `02. RB Client Companies` at `https://drive.google.com/drive/folders/1QsXdHqqBc5Qj5vyoDD3k0VhLsEzyU_ro`.
Group/external classification: external client root, because the parent chain ends at `https://drive.google.com/drive/folders/1Gsuk22nHrqAytDb37i41w7dfK9O1h4oy`.

## Canonical Folder Contents

| Folder/file | URL | Use |
| --- | --- | --- |
| Correspondence | `https://drive.google.com/drive/folders/1KIay8muZHBwTgWU5KXq7Cc7TytjDIKJC` | 2026 correspondence/incoming material. |
| Personal Tax Filings | `https://drive.google.com/drive/folders/10cRRxdwQOCKY0VDbijns5zCAUtaZy34m` | Contains Byron personal-tax folders; detailed personal-tax pointers are in `../../Individuals/Byron Jarvis Frasier/drive-locations.md`. |
| Board Meetings | `https://drive.google.com/drive/folders/1GLt4JUlpFHXwi5LBCNPzGE94ZaBRDmEV` | Board meeting evidence for Irish tax-residence governance. Listed subfolders: 2025-08-05, 2025-11-03, 2026-02-24. |
| 2024 | `https://drive.google.com/drive/folders/1dCdvRKz-99QVoDCvoBQYR3DG-5i9T3qZ` | 2024 company accounting, accounts, bank, invoices, and backup material. |
| 2025 | `https://drive.google.com/drive/folders/1Zw3ttuPDA1uuXF1imPKVFSAEq7t0lLMa` | 2025 company correspondence and vendor folders. |
| CO-SEC | `https://drive.google.com/drive/folders/1tUnfSIawk6YyHVntYFU6D8aFHwQacx5b` | Company secretarial material. |
| AGL - Liquidity 2025 | `https://docs.google.com/spreadsheets/d/1wd8Uf9CnDtP_k-nkw5eNRZVOMCPkOlZ4jcNx-RO8W2c/edit?usp=drivesdk` | Company liquidity sheet. |
...
| AGL 2024 E-Bilanz Balance Sheet Workpaper | `https://docs.google.com/spreadsheets/d/14bHLfT_NVgBPzqmIE6v7nmZQdJuxjfNiYSAa0CINx-Q/edit?usp=drivesdk` | Prepared 2026-05-25 for the Finanzamt E-Bilanz request. Final clean local review pack also saved at `/Users/jp/Downloads/AGL_2024_E-Bilanz_Final_Review_Pack.xlsx`. Connector import placed the Google Sheet in My Drive rather than the AGL folder; move the final pack/sheet into the AGL 2024 or Correspondence folder when a folder-aware route is available. |
