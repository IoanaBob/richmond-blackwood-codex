...
| --- | --- | --- | --- | --- |
| MONOCHROMATIC LIMITED | MONO | `https://www.notion.so/7d2d1876a3024ee0a3e5a3d1825485e0` | Listed in EIP `Shareholder of / Subsidiaries` | Do not duplicate MONO operating detail in EIP. Use MONO's own company memory when populated. |
