...
EIP client project: `EIP - EIP Ventures - Client Project` / `https://www.notion.so/32fe41301314804a8e09c51b11350b46`.

Project status in Notion: In Progress.
Project ID in Notion: `PROJ-202`.
Parent project: `https://www.notion.so/327e4130131480ceb3f9d757a8286559`.

The project page says it is for task tracking only and that long-term company data should live in the company record and connected client databases. Use this repo folder for long-term EIP memory and Notion tasks/operational rows for live follow-through.

Data-quality note: the EIP company record points to this client project, but the project page's `Companies` relation displayed a different company page during the 2026-06-05 fetch. Confirm before writing project/company relations.
...
Search also found a separate project titled `EIP Ventures` at `https://www.notion.so/335e4130131480c38c57c0f9b9558790`. It is not treated as the canonical EIP client project in this import. Fetch it when product/brand/venture-builder project management context is specifically in scope.

## Closed / Historical Items Checked

| Item | Status | Source | Notes |
| --- | --- | --- | --- |
| EIP Return of allotments rejected | Done | `https://www.notion.so/335e41301314815aacaec1f4bb5a4a80` | Historical 2022 Form B5 rejection note; Notion marks the task done. |
