...
| --- | --- | --- | --- | ---: | --- |
| 2024 | `/Users/jp/Downloads/eBilanz_uploads_2026-06-04_v2/CLV_2024_ebilanz_import.xlsx` | `clv_2024_rebuilt_source.xlsx` | `Trial Balance 2024` | 28 | Ready for platform upload, then mapping/validation review. |
...
- Workbook shape follows the accepted Aaron/CLV import pattern: single `Import` sheet with `Konto`, `Beschriftung`, `Saldo`, and `S/H`.
