...
RBL client project: `RB - Richmond Blackwood - Client Project` / `https://www.notion.so/32fe4130131480779ce6cb2a311c51e4`.

Project status in Notion: In Progress.
Project ID in Notion: `PROJ-209`.

The project page says the project is task-tracking only and that long-term client/company data should live in the company record and connected client databases. Use this repo folder for long-term RBL memory and Notion tasks/operational rows for live follow-through.
...
| Source | URL | Notes |
| --- | --- | --- |
| Adam topics to discuss 14.11.2025 | `https://www.notion.so/2aae41301314804b95aedbffb196bfe0` | Internal/legal/accounting agenda context. Read as operational context, not as current RBL filing status. |
| RB Porting to Sage Exploration | `https://www.notion.so/33de41301314805ca8c5c4b429df2858` | Practice-wide accounting system strategy and Sage migration questions. |
