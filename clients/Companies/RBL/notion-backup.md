...
| Record | URL | Notes |
| --- | --- | --- |
| Company | `https://www.notion.so/60b3d344d0734dc5a2e30d012be50804` | Canonical `Reference` is `RBL`. |
| Client project | `https://www.notion.so/32fe4130131480779ce6cb2a311c51e4` | Task-only project for RBL work. |
| Client dashboard | `https://www.notion.so/1b5e4130131481e29c87dbf5462ec289?v=1b5e4130131481a187fe000c97503b0e&source=copy_link` | Dashboard URL stored on the company record. |
| Parent project | `https://www.notion.so/327e4130131480ceb3f9d757a8286559` | Parent project relation from the RBL project. |
...
No new Client Notes & Updates page or Notion backup page was created. The current repo memory is a source-indexed synthesis of existing Notion records and public CRO Open Data.
