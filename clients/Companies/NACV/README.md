...
Register number: 734175.
Incorporated in: Ireland.
Registered on: 2023-01-31.
Registered office: Workhub, 77 Camden Street Lower, Dublin 2, D02 XE80, Ireland.
Correspondence address in Notion: Scanbox #11780 c/o EIP Ventures Limited, Ehrenbergstr. 16a, 10245 Berlin.
Company email: `contact+nacapitalventuresltd@richmondblackwood.com`.
Accounting software: Lexoffice.
Communication preference: WhatsApp.
Service: Managed Services.
RB monthly fee: EUR 1,000.
Approval status in Notion: Approved.
Onboarding status in Notion: Active & Onboarded.
Tax residence in Notion: Germany.

## Current Snapshot

NACV is an Irish company treated operationally as German tax resident in the live Notion records. Andrei Nasonov is a director, UBO, shareholder, and employee in Notion. Eran Peer is also listed as a director. Richmond Blackwood Limited is the company secretary.
...
Company operations, contracts, invoices, bookkeeping, payroll, VAT, corporation tax, trade tax, company-side correspondence, and NACV project context belong in this folder.

Andrei-specific personal tax, spouse/joint filing context, individual tax evidence, private insurance/TK follow-up, personal bank or asset details, and individual-owned documents belong in `../../Individuals/Andrei Nasonov/`.

Raw client evidence stays in Drive or Notion. Credential or certificate attachments, identity documents, raw WhatsApp transcripts/media, Gmail attachment identifiers, bank-account details, ELSTER credential material, exact tax identifiers, and tax-payment bank details are not copied into git.
