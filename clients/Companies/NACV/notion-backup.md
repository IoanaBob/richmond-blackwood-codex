...
Status: provisional.
Source: Notion connector reads on 2026-05-19.
Imported: 2026-05-19.
Review: No Notion records were added or modified in this PR. Existing tasks already capture the main follow-ups.

## Primary Records

| Record | URL | Scope |
| --- | --- | --- |
| Company | `https://www.notion.so/d97abab7377f4d29b7fb11d4262906c8` | NACV company facts, reference, registrations, linked records. |
| Client project | `https://www.notion.so/32fe413013148083a7d0fa4f8d94c3e9` | NACV project and task list. |
| Andrei individual | `https://www.notion.so/e275d80810824aa7bcc7cf7b7b6fd072` | Personal-tax and linked-role context; details routed to individual folder. |
| Eran individual | `https://www.notion.so/59b94a27de954b50b34e0818601b7eac` | Director relation only in this import. |

## Key Existing Tasks

| Task | URL | Status at read | Notes |
| --- | --- | --- | --- |
...
| Andrei personal tax analysis | `https://www.notion.so/352e41301314804a9895db42f9cf07af` | In Review | Blocks 2024 filing task; workbook exists in Drive. |
| 2024 German Personal Tax Filing - Andrei Nasonov | `https://www.notion.so/364e413013148174b03aefbc624e1e38` | Task | Filing task linked from 2024 personal-tax filing. |

## Backup Decision

This PR updates repo context only. No Client Notes & Updates page was created because the existing operational Notion records already hold the live action items.
