...
RB monthly fee in Notion: EUR 9,500.

Previous names recorded on the company page:

- KONVI FIVE YEAR WATCH HOLDINGS 001 LTD.
- KONVI CROWDFUNDING LTD, until Q4 2024.
...
Company operations, contracts, accounting, filings, filing registrations, RB billing, Konvi group internal tasks, and company source pointers belong in this folder.

Personal tax work, full private-channel transcripts, personal identifiers, bank details, raw document access links, credentials, and SignNow links must not be copied into git.
