...
Status: provisional.
Source: Notion Company `KONVI LIMITED`, linked client database records, internal Notion tasks/documents, and user instruction on 2026-05-26.
Imported: 2026-05-11; updated 2026-05-26.
Review: keep this file to source pointers and route IDs only; do not paste credentials, bank details, document access links, personal identifiers, or private channel transcripts.
...
| Notion active tasks | 2026-05-26 | VAT/ROS demand, Revenue VAT refund support, LuxTrust pack, mailbox setup, Dracoon invoice evidence, passive-income payout process, XVault risk, tax-support landing page, and shareholder query are summarized in `client-project.md`. |
| Notion archived/done tasks | 2026-05-26 | Annual-return task, Garvan/Emma duplicate offboarding task, Banksy liquidity support signing, and booking-link variant check were read to avoid treating closed items as active. |
| Notion internal documents | 2026-05-26 | `Konvi Name Change - Requirements` `https://www.notion.so/36a20143c9fd41e79252a34d1a906052`; `Tax /VAT Numbers Coordination` `https://www.notion.so/191e413013148079bea3cc22e3d972a8`; `Fixing VAT` `https://www.notion.so/1cbe413013148096a633f8d41011cb1e`. |
| Notion Call `RBCALL-11` | 2026-05-11 | Controlled calling-bot test context and Context Pack; controlled test only, reset/re-approve deliberately before retry. |
| ElevenLabs conversation `conv_9101krcf4cjcfynt5gc06rvq5v8y` | 2026-05-11 | Controlled test-call failure: early stop, internal-source language, and pronunciation issues. Do not store full transcript in git. |
