...
Imported: 2026-06-08.
Review: Reconcile debt-register sync, May invoice company relation, subscription register issuance, and any payment-proof requirements in live Notion before acting.
...
| 2026-05-28 | `https://app.notion.com/p/360e4130131481c78f6ceb1d23056c7a` | USD | Paid | Linked to EVG contract, but fetched `Company` relation points to KONVI; review/repair before relying on company rollups. |
...
| Techpacito subscription | Active | `https://app.notion.com/p/357e4130131481588cfbf94786e3c497` | EUR 30,000 subscription; settlement marked complete effective 2026-05-31 from user confirmation. Register/coupon/referral schedule review remains. Bank details and SignNow IDs intentionally excluded. |
...
| Item | Status | Source | Notes |
| --- | --- | --- | --- |
| Phillips invoice/payment status and asset/payable booking | To Do | `https://app.notion.com/p/36ce413013148166a211c2af21542d29` | Task says invoice/bid-form evidence is in Drive and next action is to verify whether payment already occurred before setting payable status, then book/route asset and invoice evidence. Bank transfer details intentionally excluded. |
