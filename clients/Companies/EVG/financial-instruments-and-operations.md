...
EVG process pages define a structured operating model for counterparty onboarding, approvals/signatures/communications, and physical auction representation/liquidity support:

| Process | Source | Operating relevance |
| --- | --- | --- |
| Counterparty Onboarding and Authority | `https://app.notion.com/p/355e41301314810fb43dc431ae8b2595` | Client/counterparty rows should clarify business area, role, stage, deadline, manager, communication method, signatory, KYC, agreements, and evidence before execution. |
| Approvals, Signatures, and Communications | `https://app.notion.com/p/355e41301314819390fee994637bf63b` | Governs review-before-send, SignNow, desk email, Communications logging, signer roles, and final signed-version distribution. |
| Physical Auction Representation and Liquidity Support | `https://app.notion.com/p/355e41301314815b88cefe91ebcbbb08` | Governs asset research, auction-house negotiation, transaction schedules, activation notices, support bids, auction result capture, and payment/settlement. |

Representative operating row:

| Row | Stage | Source | Notes |
| --- | --- | --- | --- |
| Ford Escort RS Cosworth Big Turbo Valuation | In Review | `https://app.notion.com/p/359e41301314811288c0ce175dcb939c` | Physical-asset research row; external sharing is controlled through approved report routes, not raw Drive/PDF/HTML links. Final auction-house route still needed review in fetched notes. |

## Current Active / Sensitive Issues
...
- Do not send Drive, PDF, HTML, attachment, DocSend, or signing links externally unless the EVG process/user approval allows it.
- Do not include confidential internal support mechanics, seller economics, buyer identity, or side-specific references in the wrong recipient-facing communication.
- Always build external responses from verified source rows and current review bundles, especially where active notes say analysis is incomplete.
