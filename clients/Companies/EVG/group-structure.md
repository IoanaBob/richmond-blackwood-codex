...
Status: provisional.
Source: EVG Notion company record `https://www.notion.so/15fe4130131480079a95fd029aef3511`, EIP Notion/company repo memory, and user instruction on 2026-06-08.
Imported: 2026-06-08.
Review: Use the live EIP group-structure task before relying on direct/indirect/portfolio classifications for external, legal, tax, or banking purposes.

## Ownership Context

EVG is listed as part of EIP's direct subsidiary/shareholder-of set in the EIP company import. The EVG Companies row lists EIP VENTURES LIMITED as shareholder company, plus Ioana Surdu-Bob and Eran Peer as shareholder individuals.

EIP group context: `../EIP/subsidiaries-and-group-structure.md`.

## Related Company Pointers

| Company | Reference | Relationship observed | Source | Notes |
| --- | --- | --- | --- | --- |
...
The EIP live task `Create EIP group structure diagram` (`https://app.notion.com/p/378e41301314811f8e8edbfaa69afca0`) should include EVG when the fuller direct/indirect/portfolio/separately-owned classification is produced.
