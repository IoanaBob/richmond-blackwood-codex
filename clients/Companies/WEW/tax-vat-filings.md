...
Status: provisional.
Source: live Notion annual VAT setup run on 2026-06-06; existing WEW company folder and Drive export records.
Imported: 2026-06-06.
Review: Complete a broader WEW company tax/VAT import only when company filing review is in scope. Keep annual VAT placeholders pending until submission proof and payment/refund handling are verified.
...
Status: provisional.
Source: live Notion payroll registration and Employment record read on 2026-06-06.
Imported: 2026-06-06.
Review: Confirm payroll values and filing proof before marking filed.

The live payroll registration existed but was linked only to broad German tax-return rows. Teresa's German employment record supports a 2025 payroll filing placeholder, so a dedicated Payroll Tax Filing row was created for attachment and tracking.

| Filing | Registration | Status | Filing period | Due date | Source |
| --- | --- | --- | --- | --- | --- |
| WEW - Payroll Tax - 2025 | WEW Payroll Tax registration | Overdue | 2025-04-01 to 2025-12-31 | 2026-01-12 | `https://www.notion.so/377e413013148169941fca8a9777d7c2` |

## ZM / VIES Review

Status: provisional.
Source: live Notion company and business-partner review on 2026-06-06.
Imported: 2026-06-06.
Review: Recheck invoice-level customer VAT data if WEW has VAT-numbered EU business customers for any filing period.

No German ZM/VIES rows were created for WEW in this pass. The company context references EMEA/EU/German-speaking clients, but the fetched business-partner evidence for GATHER NO MOSS CREATIVE LIMITED did not show VAT-registered EU customer evidence. Current records therefore do not support creating ZM placeholders without invoice-level review.
