...
| --- | --- | --- | --- | --- | --- |
| 2026-06-02 | `WeWrite Creative Limited  - Handover - Richmond Blackwood` (`https://drive.google.com/drive/folders/1C3RnMZsxGWc8ZprC8V7C251ldtyROhT3`) | `info@cllm.de` | `reader` | Google notification email disabled; bespoke email sent from `accounting@richmondblackwood.com`. | Permission creation and readback succeeded through `accounting@richmondblackwood.com` persona. Gmail thread: `https://mail.google.com/mail/u/0/#all/194f49722b970630`. |
