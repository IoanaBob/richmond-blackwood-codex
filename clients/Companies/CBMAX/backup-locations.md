...
The source-of-truth client records already exist in Notion under the Client Databases hub. Raw evidence and client files should remain in Drive.

This repo folder keeps:

- Source registers.
- Routing notes.
- Pointers to Notion, Drive, Gmail, and task records.
- Blockers and review questions.

## Prior Provisional Import

Notion has a previous Client Notes & Updates page:

- `Codex provisional import - CBMAX`: `https://www.notion.so/356e413013148123b1fff0e8de5c3c4f`
