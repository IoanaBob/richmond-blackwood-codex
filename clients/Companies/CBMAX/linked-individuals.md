...
Imported: 2026-05-13.
Review: Claudio's individual folder now exists for personal-tax/private routing. Confirm whether to create individual folders for Eran Peer, Semen, and Viktor before importing personal tax, KYC, or personal identifier detail.
...
| --- | --- | --- | --- | --- |
| Claudio Brivio | `../../Individuals/Claudio Brivio/` | Director, UBO, shareholder individual, employee, client POC | `https://www.notion.so/2242215d7fdc4efe9f3a33693601fe7b`; company record; personal tax context load on 2026-05-13 | Store personal tax, KYC, and personal identifiers in the individual folder. Company files keep only company-side pointers. |
