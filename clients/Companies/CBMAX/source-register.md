...
| ELSTER Hamburg annual VAT zero-return evidence | 2026-06-02 | User-provided local PDFs `CBMAX Hamburg 2024 VAT return.pdf` and `CBMAX Hamburg 2025 VAT return.pdf` uploaded to Drive folders `2024` and `2025`, then linked in Notion filing row `https://www.notion.so/36fe413013148074906dff68162e653b`. Drive URLs and hashes are in `drive-locations.md`; filing context is in `tax-vat-filings.md`. |
