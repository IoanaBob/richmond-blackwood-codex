...
Imported: 2026-05-25.
Review: create and verify each client-specific Xero custom connection before using it for RB client work; confirm the active-client switcher is acceptable after the first live client test.
