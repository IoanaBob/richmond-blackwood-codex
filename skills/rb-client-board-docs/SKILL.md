...
- Update the relevant client `drive-locations.md`, `source-register.md`, or domain file with the board-folder URL and any important evidence pointers when the repo needs durable access.
