...
- `rb-finanzamt-payment-proof-response`: prepare German Finanzamt payment-proof responses, match notices to payment evidence, preserve packets in Drive, and draft responses without sending until approved.
