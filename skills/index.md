...
- `rb-company-tax-de`: prepare German company tax filings in ELSTER, including nil corporation/trade tax returns, with the operator clicking final submission unless explicitly authorised otherwise.
