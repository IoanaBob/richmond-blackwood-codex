...
- `rb-personal-tax-filing-de-elster`: file German personal tax returns through ELSTER from RB workbooks, with certificate/QR login routing, page-by-page review, draft-PDF review, and strict no-submission guardrails.
