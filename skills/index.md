...
- `rb-inbound-operating-triage`: generalized inbound operating triage across Gmail, Slack, WhatsApp, Notion, status systems, files, and other configured channels.
