...
- `rb-communications-follow-through`: move canonical RB Communications rows forward through row-led packet review, evidence/reply/task updates, approved sends, and verified closeout.
...
- `rb-germany-growth`: master daily Germany growth orchestration across audience targets, channel skills, Business Partners, Growth Targets, Growth Messages, Communications handoffs, Tasks, and in-run compliance gates with Ioana-only send gates and timestamp-based reporting.
...
- `rb-germany-growth-facebook-posting`: Facebook group public posting/comment/reply flow; non-commercial group participation targets route to Growth Targets and Growth Messages.
...
- `rb-de-freelancer-deregistration`: prepare German freelancer / self-employed tax deregistrations with Finanzamt or ELSTER, including field choice, prepayment handling, Drive evidence, and Notion closeout.
