...
- An authenticated browser or direct Notion API export path that can prove it read the full table, including total row count or unambiguous pagination completion.
