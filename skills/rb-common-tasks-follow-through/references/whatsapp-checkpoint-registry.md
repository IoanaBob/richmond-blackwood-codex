...
| NACV / Andrei | `120363399321589278@g.us` | common-tasks manual-run only | 2026-06-04 08:00 GMT (09:00 Europe/Dublin) | No messages in window; use timestamp lower bound | `2026-06-04-0933-jun03-04-0800-gmt` | provisional | Stage 3 empty-window read plus Stage 11 source-marker results | No in-window messages. |
...
| VUN / Nathan | `120363392073065176@g.us` | common-tasks manual-run only | 2026-06-04 08:00 GMT (09:00 Europe/Dublin) | No messages in window; use timestamp lower bound | `2026-06-04-0933-jun03-04-0800-gmt` | provisional | Stage 3 empty-window read plus Stage 11 source-marker results | Targeted JID read should be used while `list_chats` remains unreliable. |
