...
6. Draft Packet
   ...
   - For Reddit copy, avoid the word "path," avoid slash-heavy phrasing, avoid long enumerations unless the local style supports them, and avoid mechanical contrast sentences that read like a template.
