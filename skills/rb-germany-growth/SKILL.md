...
- Reddit planning uses a daily cap of 3 approved public posts/comments for the active Reddit account, spaced at least 15 minutes apart. Treat this as a maximum, not a quota to force. Replies, reply-thread follow-ups, DMs, reactive DMs, modmail, votes, saves, passive scrolling, and second comments on the same post are excluded from the cap. Posting still requires exact approval and immediate Ioana Reddit-session verification.
...
3. Daily Queue
   ...
   - Count Reddit public posts/comments posted today, safe public post/comment drafts, high-risk/provisional drafts, timestamp of the last public post/comment, earliest next allowed public post/comment time, and remaining capacity against the 3/day public Reddit cap. Do not count replies, DMs, follow-ups, passive scrolling, or second comments on the same post.
...
4. Channel Work Packets
   ...
   - For Reddit, include the 3/day public Reddit cap state, last post/comment timestamp, earliest next allowed public post/comment time, and any sourcing/drafting gap. Do not fill the cap with weak or stale threads.
...
6. Draft Packet
   ...
   - For any growth call hold or invite, use the sender persona calendar through the OAuth vault only. If the calendar tool asks for reauth or opens a consent URL, stop and log the missing OAuth-vault route as a blocker.
...
9. Reporting And Closeout
   ...
   - For Reddit, report public posts/comments posted from Growth Messages `Message Kind = Post` or `Comment` plus `Growth Event At`, daily 3-action cap remaining, last public post/comment timestamp, earliest next allowed public post/comment time, safe drafts, high-risk/provisional drafts, replies/DMs excluded from the count, and blockers.
