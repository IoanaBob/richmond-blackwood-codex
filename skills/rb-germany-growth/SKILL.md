...
- LinkedIn reply triage must not draft or send a reply until a prospect-specific overarching reply strategy has been agreed in chat, saved on that prospect's Growth Target page, and read back.
...
4. Channel Work Packets
   ...
   - For LinkedIn reply-drafting packets, first require a `Reply Strategy Packet`: read the Growth Target, propose the overarching strategy, get user approval, save it on the prospect's Growth Target page, and read it back before any reply text is drafted or sent.
