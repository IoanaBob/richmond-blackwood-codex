...
- 2026-05-25 Finanzamt packet: payroll-tax query is the immediate priority because AGL had German employment from 2024-05-01 and visible payments/credits exist without matching processed Lohnsteuer-Anmeldungen. Extracted payslip basis for May 2024-April 2025 totals EUR 78,000.00 gross, EUR 20,715.82 Lohnsteuer, EUR 206.13 SolZ, EUR 0.00 Kirchensteuer, and EUR 20,921.95 payroll-tax total. Visible Mein ELSTER transmitted-form history did not show Lohnsteuer-Anmeldungen, subject to the external-software caveat. May 2024 is prepared and validated in ELSTER but not submitted pending explicit approval.
- E-Bilanz workpaper prepared on 2026-05-25: `https://docs.google.com/spreadsheets/d/14bHLfT_NVgBPzqmIE6v7nmZQdJuxjfNiYSAa0CINx-Q/edit?usp=drivesdk`. It ties the final FY24 SFS trial balance to the abridged financial statements: turnover EUR 157,525.50, administrative expenses EUR 171,972.62, loss EUR 14,447.12, debtors EUR 13,412.17, statutory net cash EUR -27,767.77, net assets/equity EUR -14,355.60. It is not an XBRL/datensatz; final mapping remains open for negative bank balances and whole-company vs German PE/tax-balance scope.
