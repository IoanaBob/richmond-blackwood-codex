...
- Germany growth communications rule: the `RB Germany Growth System` project is `https://www.notion.so/372e41301314817bb344fbb0a11d9ae8` and is for Tasks only; the growth operating databases live under `RB Client Databases` (`https://www.notion.so/f272baa16c3b45069cbd896624e04b5c`) in the Richmond Blackwood teamspace. American tech workers in Germany / relocating to Germany is the first audience target, not the system boundary. Pre-lead growth drafts, sends/posts, comments, DMs, replies, blockers, approvals, and follow-ups use `RB DE Growth Messages` (`https://www.notion.so/ca339af617e5497483970cac110abc03`, data source `collection://0eb425a4-f739-412c-acc6-3fee8cc825df`) with `Audience Target`, `Growth Channel`, `Sender Identity` when the select supports the sender, `Platform Account`, `Message Kind`, `Status`, and timestamp fields. Canonical Communications is used only when a growth thread is promoted into a lead/client/business communication and linked through `Promoted Communication`. Partnership prospects use existing Business Partners (`https://www.notion.so/a179e21f0e014f4db65bbe59135c9d0f`) with optional `Audience Target`, `Growth Channel`, `Growth Stage`, `Ioana Gate`, and growth milestone timestamps; non-partner LinkedIn/Facebook posting/Reddit/direct research targets use Growth Targets with stage/event timestamps. Facebook group admin/sponsorship/payment/commercial approval acquisition uses `rb-germany-growth-facebook-partnerships` and Business Partners; Facebook public group posting/commenting uses `rb-germany-growth-facebook-posting`, Growth Targets, and Growth Messages. Reddit is direct community engagement first: no moderator outreach, sponsorship, paid-post, cold/proactive DM, modmail, commercial-counterparty, or Business Partner route from Reddit unless explicitly re-enabled. Reactive Reddit DMs are allowed only after someone engages with our public post/comment or sends an inbound DM first; they stay in Growth Targets and Growth Messages and require exact approval plus immediate Eran Reddit-session verification before sending. Growth reporting is reconstructed from timestamps in Growth Messages, Growth Targets, Business Partners, Channels, and Audiences; the superseded `RB DE Growth Metrics` and `RB DE Growth Compliance Checks` sources are trashed and should not be recreated. Compliance checks happen inside skill stages, with blockers and follow-ups recorded in Growth Messages or Tasks when action is needed. LinkedIn targeting for the first audience prioritizes Germany-based tech workers employed by foreign companies, ideally US-headquartered or US-market employers, with visible US background; the younger-profile preference is handled only through public career-stage evidence, never by inferring or storing age. LinkedIn planning uses a 10-request quota-day target and a 200/month planning baseline across 20 business days; personalized invite notes are off by default. The LinkedIn skill may run several times per business day for invite batches, acceptance checks, first-message packets, reply drafting, follow-up drafting, and reporting-only closeout. Relocation partner outreach has a daily target of at least 5 new first-time email conversations with distinct Business Partner prospects per business day; replies and follow-ups do not count toward that target, and sends still require exact approval plus immediate Ioana sender-session verification. LinkedIn first messages, replies, and follow-ups must be about who the person is and what they do, and must be highly specific: name the company/product/project/system/post/launch and a real detail such as a feature, market, customer segment, technical problem, or founder decision. They should use US-vs-Germany differences when relevant: admin/taxes only as a passing joke, preferably "Admin and taxes I'm sure were much easier in the States", plus a second contrast tied to the prospect's topic. Questions must be highly pointed; broad prompts like "How are you thinking about that?" are blocked. Generic phrases like "saw the founder angle", "saw your work", "what are you focused on", "as a fellow tech founder", or "I am a tech founder too" are blocked. Outreach must not mention RB services, tax/admin offerings, savings claims, sales paths, or booking a call. The superseded Growth Partnerships source is trashed. Send-ready growth work must block unless the required channel sender identity is verified.
- Germany growth LinkedIn OpenToWork exclusion: Status: approved. Source: user instruction in chat on 2026-06-08 plus browser-visible LinkedIn read-back. Imported: 2026-06-08. Review: apply before every invite, accepted-connection first message, reply, and follow-up packet. Profiles showing LinkedIn `Open to Work`, `#OPEN_TO_WORK`, active job-seeking, unemployed, career-transition, or recruiter-facing job-hunt signals are excluded and removed from active send lists. Already-contacted OpenToWork people should receive no further proactive outreach unless they send a business-relevant Germany setup, freelance, company, tax, admin, or remote-employment signal and the user explicitly approves that exact exception.
- Germany growth LinkedIn foreigner gate: Status: approved. Source: user instruction in chat on 2026-06-10 after rejecting a freelancer-heavy invite packet as too German. Imported: 2026-06-10. Review: apply before every LinkedIn invite packet for the first audience. Targets must be Germany-based foreigners / people who visibly came to Germany from abroad. Explicit freelance, contractor, self-employed, fractional, senior technical, or high-quality profile signals are not enough on their own. Every proposed invite must show a `Foreign Background Gate` based on explicit came-from-abroad/relocation evidence, current Germany plus prior non-Germany work/study/residence, explicit US/non-Germany nationality or residency signal, or user-confirmed foreigner status. Do not infer foreigner status from name, appearance, language, or accent.
- Germany growth LinkedIn company-setup final reply rule: Status: approved. Source: user instruction in chat on 2026-06-10. Imported: 2026-06-10. Review: apply after a prospect has disclosed a real freelance, company, foreign-client, remote-employment, EOR, tax, or admin setup and the thread is closing, stalled, or softly rejected. Do not close silently; draft one concise final reply saying that if they ever want to set up through a company to save more on tax, Ioana/RB can handle the full setup end to end. Keep it low pressure, do not ask another curiosity question, and do not promise guaranteed savings. First messages remain non-salesy.
- Germany growth LinkedIn freelancer setup-interest rule: Status: approved. Source: user instruction in chat on 2026-06-10. Imported: 2026-06-10. Review: apply before any company-setup/tax-saving offer to freelancers, contractors, self-employed people, EOR users, or solo-company operators. First show interest in their current setup using what they disclosed, such as regular freelancer, Remote EOR, Dubai company, German clients, foreign clients, Toptal, UG, or current company. Do not jump straight to `we can handle it` or savings language before acknowledging/probing the setup itself.
- Germany growth Facebook posting target rule: Status: approved. Source: user instruction in chat on 2026-06-10. Imported: 2026-06-10. Review: apply before every Facebook posting/commenting run. The Facebook posting skill should source and prepare 3 relevant public group comments/replies per day across usable joined groups, using the same recency, helpfulness, style-basis, exact-approval, and Ioana-session gates used for Reddit-like community engagement. Do not fill the target with weak, stale, low-budget, job-seeker, or rule-unsafe posts.
- Germany growth Reddit reset and ramp cap rule: Status: approved. Source: user instruction in chat on 2026-06-09 after reporting the previous Reddit account was banned; updated by user instructions on 2026-06-10 and 2026-06-12. Imported: 2026-06-09. Updated: 2026-06-12. Review: apply before every Reddit run. Treat the prior Reddit account's tasks, Growth Messages, chats, and follow-ups as historical-only/no-follow-up unless the user explicitly approves a specific exception after seeing the old source context and new-account risk. Current Reddit flow must verify the active account belongs to Eran before any send; current account is `Ornery-Service3272`. Public Reddit posts/comments use a ramping daily cap for the active account: anchor date 2026-06-10 Europe/Dublin at 1 approved public post/comment, increasing by 1 every 2 calendar days, capped at 10/day (`daily_cap = min(10, 1 + floor(days_since_2026-06-10 / 2))`). Public posts/comments remain spaced at least 15 minutes apart; the gap includes only passive scrolling, reading, rules/style review, and non-sending prep. The cap is a maximum, not a quota to force. Targeting priority is very recent, within the last 3 days, slightly desperate Germany freelancer/support posts involving consulting, freelance/self-employed setup, tax, invoicing, pension/social security, false self-employment, company setup, EOR/payroll, banking/KYC, or foreign-client remote work.
- Germany growth outbound style rule: do not use list-style stacked examples, alternatives, caveats, or issue lists in outward-facing copy unless the message truly breaks without it. Use one concrete point, or two only when necessary.
- Germany growth LinkedIn Saurabh/Jesse/Anna rule: Status: approved. Source: user instruction in chat on 2026-06-08. Imported: 2026-06-08. Review: for foreign-platform income prospects who ask what Ioana can do before a call, explain the company-invoicing setup at a high level, including salary draw, retained company profit, expense optimization, and German pension/social-contribution exposure. If the user says to leave the offer in the air, do not ask another follow-up; say the consultation is free with no commitment/requirements. For very senior/high-context profiles such as Jesse Kretschmer, do not invent weird technical questions and do not put meta process phrases like `no clever q here` into the prospect-facing copy; use an honest, specific opener tied to real profile context. In recruiting/AI messaging conversations, Ioana may say she helped a Japanese company build something in the space a while back, `neotalent.net`, only when relevant.
...
- 2025 source package: `https://drive.google.com/drive/folders/1Mj6ZqOLXKOvKRnjDDjOgqDriLodkBEiY`
- 2025 filing workspace: `https://drive.google.com/drive/folders/1OVx_u0u8dpGZ6sm_vhc20ItMrnMXz0GJ`
- Fresh 2025 analysis workbook: `https://docs.google.com/spreadsheets/d/1-hmXCtlh3RMSKzd10oRtpK5CZvmCuxwnCJ6ZoijM_m8/edit`
- 2025 preparation task: `https://www.notion.so/37ae4130131481e382c0c3424a69db3d`
- 2025 filing task: `https://www.notion.so/37ae4130131481228f5dd6e79267ee9b`
- Superseded Office workbook: `https://docs.google.com/spreadsheets/d/1u6pS1K9MfBDn35o96iPgqQ27zxbZ1DG0/edit`
- Status: personal-tax/private context loaded on 2026-05-13; fresh 2024 workbook prepared later the same day from the maintained native template and linked to the live filing via preparation/filing tasks. Operator review on 2026-05-14 approved health/care, home-office, Pixel Buds, and phone; excluded CBMAX February payroll, commute, Telekom internet, and Hallesche non-basic; and instructed that Section 138 AO notifications should be filed for CBMAX and Job Guardian. Current 2024 workbook read-back shows 8 failed checks and 27 open missing-info items, mainly CBMAX 2024 Lohnsteuerbescheinigung, N26 investment statement classification, Section 138 late/proactive wording and foreign-company risk review, and optional Freenet invoice extraction. The former company-side question about whether Claudio needs an individual folder is resolved; avoid duplicating Claudio personal-tax detail in CBMAX company files. 2025 filing is now `In Progress` in Notion with fresh Drive-native workbook and source package linked. Latest 2025 workbook read-back after the 2026-06-12 operator correction shows gross employment income EUR 30,000.00, wage tax withheld EUR 3,420.96, employment work expenses used EUR 1,230.00, actual itemized employment expenses EUR 1,135.58, health/care EUR 5,597.63, investment interest EUR 1,150.81, investment withholding EUR 303.48, known withholding/payments EUR 3,724.44, business/freelance net PNL EUR 0.00, and income after deductions before tax-rate calculation EUR 24,287.18. The CBMAX 2025 annual Lohnsteuerbescheinigung was uploaded and linked on 2026-06-11 at `https://drive.google.com/file/d/1olIphOCNpIgBl_zPs1FqVz4_mIUGtFOb/view?usp=drivesdk`, then attached to the December 2025 Notion payroll `Payslip` property and verified by read-back; local PDF text extraction was unavailable, so visual totals reconciliation remains. N26 treatment was approved on 2026-06-11: EUR 1,150.81 is interest/capital income received and EUR 303.48 is tax withheld by N26. On 2026-06-12, operator correction excluded coworking meal allowance because coworking days were not external workdays and excluded BVG because full work use is not supportable against home-office overlap without day-level travel evidence. After operator approval, the 2025 preparation task was marked `Done`, the filing row document-gathering status was set to `Attached in Drive`, the filing task moved to `In Review` for JP, and Slack handoff links were sent/logged. Remaining filer review flags are annual certificate visual reconciliation, Section 138/AUS continued-holdings framing, and the prior-year opening-link workbook check.
...
- No WhatsApp route is recorded for RBL in this import/update.
- Current company state from Notion/CRO: Irish incorporated and tax resident, Xero accounting software, internal group managed services, Low risk, company number 735818, registered on 2023-02-28. CRO Open Data returns the registered office as Workhub, 77 Camden Street Lower, Dublin 2, D02 XE80; the Notion company registered-office field was updated and read back on 2026-06-05.
...
- High-signal active checks: SimplePay debit-card billing blocker, Wamo payment-approval support task, Sage/Xero migration decision, and confirming Workhub VAT/exact upgraded-plan treatment for RBL after user said RB likely paid the upgraded amount.
