...
- 2026-05-25 annual VAT status: AGL 2024 Umsatzsteuererklaerung is prepared in Mein ELSTER, validated with no errors, and sitting at final `Absenden` review with EUR 0.00 final VAT/refund. It has not been submitted yet because the user is reviewing the final screen. Local USt Bescheid `Agile Lincs 2024.pdf` dated 2026-03-23 assessed EUR 5,200.00 VAT plus EUR 75.00 Verspaetungszuschlag and likely explains the VAT component of the Mahnung; after annual VAT submission, request processing/amendment and collection pause.
- E-Bilanz workpaper prepared on 2026-05-25: `https://docs.google.com/spreadsheets/d/14bHLfT_NVgBPzqmIE6v7nmZQdJuxjfNiYSAa0CINx-Q/edit?usp=drivesdk`; final clean local pack `/Users/jp/Downloads/AGL_2024_E-Bilanz_Final_Review_Pack.xlsx`. It ties the final FY24 SFS trial balance to the abridged financial statements: turnover EUR 157,525.50, administrative expenses EUR 171,972.62, loss EUR 14,447.12, debtors EUR 13,412.17, statutory net cash EUR -27,767.77, positive bank balances EUR 11,285.14, negative bank balances/overdrafts EUR 39,052.91, and net assets/equity EUR -14,355.60. It is not an XBRL/datensatz; the final pack recommends separating negative bank balances as current bank liabilities for German mapping and assumes whole-company statutory accounts because no German PE-only balance sheet was located.
