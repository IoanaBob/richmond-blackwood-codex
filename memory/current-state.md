...
- Accounting Team Updates triage rule: keep the weekday 11:00 Accounting Team Updates pass separate from inbound communication follow-through; process the current working day's blockers/action points only, skip `New client inbounds`, write verified task links back to the Team Updates page, then send the standard `#rb-client-updates` completion notice linking that page when at least one task was created, updated, or commented.
...
- 2026-05-25/26 Finanzamt payroll packet: payroll-tax query was handled first because AGL had German employment from 2024-05-01 and visible payments/credits existed without matching processed Lohnsteuer-Anmeldungen. Extracted payslip basis for May 2024-April 2025 totals EUR 78,000.00 gross, EUR 20,689.60 Lohnsteuer, EUR 232.35 SolZ, EUR 0.00 Kirchensteuer, and EUR 20,921.95 payroll-tax total. After explicit user approval, all May 2024-April 2025 Lohnsteuer-Anmeldungen were submitted in ELSTER on 2026-05-25. On 2026-05-26, local payroll evidence packet `/private/tmp/agl_payroll_evidence_packet/` was prepared; Drive XLSX allocation copy is `https://docs.google.com/spreadsheets/d/1JSN889NGPc86tCTBHhEVSiB_hylx2Ww0/edit?usp=drivesdk&ouid=109514422493708579539&rtpof=true&sd=true`, and Google Doc message draft is `https://docs.google.com/document/d/15lYOEt6XIl1xSurPnt5wUMQ-MzNiq9jhNcxbKwqqw_g/edit?usp=drivesdk`. ELSTER Belegnachreichung is drafted on the 2024 Lohnsteuer-Anmeldung evidence route with text and attachment description populated, but the in-app browser cannot attach the local PDF through ELSTER's hidden file input; the operator must manually select `/private/tmp/agl_payroll_evidence_packet/AGL_Lohnsteuer_2024-05_bis_2025-04_Beleguebersicht.pdf`. The first reviewed Belegnachreichung is the control template for same-route payroll evidence follow-ups; reusable rules now live in `skills/rb-finanzamt-payroll-evidence/SKILL.md` and `skills/rb-finanzamt-response/SKILL.md`. The individual Notion payslip/payment-proof PDFs still need uploadable file paths or separate follow-up if Finanzamt requests them.
- 2026-05-25/26 annual VAT and USt assessment status: after user approval, AGL 2024 Umsatzsteuererklaerung was submitted in Mein ELSTER with EUR 0.00 final VAT/refund. ELSTER Transferticket `ep1454t90i8mmb5zp5wtk182ewbfh5wq`, submitted 2026-05-25 at 23:01:09 for Ordnungskriterium `29/628/00250`. The user-saved ELSTER return/review PDF was uploaded to Drive at `https://drive.google.com/file/d/1aFHjF8spGtE1g_tYavgmG2rO9-jYsTP2/view?usp=drivesdk` and recorded in Notion comments `36be4130-1314-81ca-9006-001dfcf9a622` and `36be4130-1314-81d9-b2eb-001d8a850ea2`. The four incoming May 2026 Finanzamt letters/scans and Q1-Q4 2024 UStVA protocols were also uploaded to AGL Drive and indexed in `clients/Companies/AGL/drive-locations.md`. Local USt Bescheid `Agile Lincs 2024.pdf` dated 2026-03-23 assessed EUR 5,200.00 VAT plus EUR 75.00 Verspaetungszuschlag and likely explains the VAT component of the Mahnung. On 2026-05-26, a holding `Sonstige Nachricht` was submitted with ticket `ep1462eym8u2br1mdekveum80xchf83n`, and a formal USt 2024 `Einspruch` with full AdV request was submitted with ticket `ep1465aipg984922yz1tff6f2r95kktx`.
- E-Bilanz workpaper prepared on 2026-05-25: native Google Sheet `https://docs.google.com/spreadsheets/d/14bHLfT_NVgBPzqmIE6v7nmZQdJuxjfNiYSAa0CINx-Q/edit?usp=drivesdk`; final clean local pack `/Users/jp/Downloads/AGL_2024_E-Bilanz_Final_Review_Pack.xlsx`; AGL 2024 Drive `.xlsx` copy `https://docs.google.com/spreadsheets/d/1vDxZcoAmk0bPaKiGi9F1mqz4rzX1UMeq/edit?usp=drivesdk&ouid=109514422493708579539&rtpof=true&sd=true`. It ties the final FY24 SFS trial balance to the abridged financial statements: turnover EUR 157,525.50, administrative expenses EUR 171,972.62, loss EUR 14,447.12, debtors EUR 13,412.17, statutory net cash EUR -27,767.77, positive bank balances EUR 11,285.14, negative bank balances/overdrafts EUR 39,052.91, and net assets/equity EUR -14,355.60. It is not an XBRL/datensatz; the final pack recommends separating negative bank balances as current bank liabilities for German mapping and assumes whole-company statutory accounts because no German PE-only balance sheet was located.
