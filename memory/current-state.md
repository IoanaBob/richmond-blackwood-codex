...
- 2026-05-25/26 Finanzamt packet: payroll-tax returns May 2024-April 2025 and the 2024 annual VAT return have been submitted in ELSTER after user approval. Annual VAT transfer ticket is `ep1454t90i8mmb5zp5wtk182ewbfh5wq`; the submitted holding message ticket is `ep1462eym8u2br1mdekveum80xchf83n`; the formal USt 2024 Einspruch/AdV ticket is `ep1465aipg984922yz1tff6f2r95kktx`. Canonical Communications records for the two sent authority messages are `https://www.notion.so/36be413013148131a995ca7dc0decfcf` and `https://www.notion.so/36be413013148176af0bee390cdde567`.
- 2026-05-26 payroll evidence allocation: local packet `/private/tmp/agl_payroll_evidence_packet/` reconciles EUR 20,921.95 of Lohnsteuer/SolZ payments to the filed May 2024-April 2025 returns. Drive XLSX is `https://docs.google.com/spreadsheets/d/1JSN889NGPc86tCTBHhEVSiB_hylx2Ww0/edit?usp=drivesdk&ouid=109514422493708579539&rtpof=true&sd=true`; Google Doc draft is `https://docs.google.com/document/d/15lYOEt6XIl1xSurPnt5wUMQ-MzNiq9jhNcxbKwqqw_g/edit?usp=drivesdk`. ELSTER Belegnachreichung is drafted on the 2024 Lohnsteuer-Anmeldung route but remains unsubmitted because the operator must manually select the local PDF; reusable route/upload rules now live in `skills/rb-send-elster-message/SKILL.md` and `skills/rb-finanzamt-response/SKILL.md`.
- 2026-05-25 E-Bilanz workpaper: final clean review pack is `/Users/jp/Downloads/AGL_2024_E-Bilanz_Final_Review_Pack.xlsx`; AGL 2024 Drive `.xlsx` copy is `https://docs.google.com/spreadsheets/d/1vDxZcoAmk0bPaKiGi9F1mqz4rzX1UMeq/edit?usp=drivesdk&ouid=109514422493708579539&rtpof=true&sd=true`. It is a support pack for E-Bilanz software, not the XBRL/datensatz submission.
