...
- Germany growth communications rule: the `RB Germany Growth System` project is `https://www.notion.so/372e41301314817bb344fbb0a11d9ae8` and is for Tasks only; the growth operating databases live under `RB Client Databases` (`https://www.notion.so/f272baa16c3b45069cbd896624e04b5c`) in the Richmond Blackwood teamspace. American tech workers in Germany / relocating to Germany is the first audience target, not the system boundary. Growth drafts, sends, replies, blockers, and follow-ups use canonical Communications with `Audience Target`, `Growth Channel`, `Sender Identity`, `Growth Event`, and `Growth Event At` fields. Partnership prospects use existing Business Partners (`https://www.notion.so/a179e21f0e014f4db65bbe59135c9d0f`) with optional `Audience Target`, `Growth Channel`, `Growth Stage`, `Ioana Gate`, and growth milestone timestamps; non-partner LinkedIn/Facebook posting/Reddit/direct research targets use Growth Targets with stage/event timestamps. Facebook group admin/sponsorship/payment/commercial approval acquisition uses `rb-germany-growth-facebook-partnerships` and Business Partners; Facebook public group posting/commenting uses `rb-germany-growth-facebook-posting`, Growth Targets, and Communications. Reddit is direct community engagement first: no moderator outreach, sponsorship, paid-post, cold/proactive DM, modmail, commercial-counterparty, or Business Partner route from Reddit unless explicitly re-enabled. Reactive Reddit DMs are allowed only after someone engages with our public post/comment or sends an inbound DM first; they stay in Growth Targets and Communications and still require exact approval plus immediate Ioana Reddit-session verification before sending. Growth reporting is reconstructed from timestamps in Communications, Growth Targets, Business Partners, Channels, and Audiences; the superseded `RB DE Growth Metrics` and `RB DE Growth Compliance Checks` sources are trashed and should not be recreated. Compliance checks happen inside skill stages, with blockers and follow-ups recorded in Communications or Tasks when action is needed. LinkedIn planning for the first audience uses an internal target of 320 blank connection requests/month, calculated as a 16-request planning baseline across 20 business days, with a normal send range of 15-20 blank requests/business day; personalized invite notes are off by default. The LinkedIn skill may run several times per business day for invite batches, acceptance checks, first-message packets, reply drafting, follow-up drafting, and reporting-only closeout. Relocation partner outreach has a daily target of at least 5 new first-time email conversations with distinct Business Partner prospects per business day; replies and follow-ups do not count toward that target, and sends still require exact approval plus immediate Ioana sender-session verification. LinkedIn first messages, replies, and follow-ups must be about who the person is and what they do, and must be highly specific: name the company/product/project/system/post/launch and a real detail such as a feature, market, customer segment, technical problem, or founder decision. They should use US-vs-Germany differences when relevant: admin/taxes only as a passing joke, preferably "Admin and taxes I'm sure were much easier in the States", plus a second contrast tied to the prospect's topic. Questions must be highly pointed; broad prompts like "How are you thinking about that?" are blocked. Generic phrases like "saw the founder angle", "saw your work", "what are you focused on", "as a fellow tech founder", or "I am a tech founder too" are blocked. Outreach must not mention RB services, tax/admin offerings, savings claims, sales paths, or booking a call. There is no separate growth outreach database, and the superseded Growth Partnerships source is trashed. Send-ready growth work must block unless Ioana identity is verified.
