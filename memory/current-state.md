...
- Repo-local skills for RB source research, memory capture, process maintenance, and handoff.
...
- TypeScript check skipped because no TypeScript helpers or `package.json` are retained.
