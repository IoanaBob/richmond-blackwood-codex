...
- 2026-05-25 WhatsApp retry found Byron's reply to Ioana's 2025 maintenance-payment question: no cash maintenance payments to a divorced or permanently separated spouse. Notion Communications/filing logging failed because the Notion MCP timed out, so the WhatsApp checkpoint remains unadvanced until official logging and read-back succeed.
...
- Current user-instructed position: Andrei was/is RB's first client. RB did his 2024 German personal-tax return for free; it was filed through Mein ELSTER on 2026-05-22 and the transfer-ticket proof is recorded in Notion. From 2025 onward normal-fee treatment is expected but billing mechanics are not decided. He is married, so filings should be joint. RB wants to coordinate 2024 and 2025 in one workstream while keeping one Notion filing record for each year. No spouse individual folder is needed because she is not a company shareholder.
...
- High-signal open items: Finanzamt prepayment notices/amounts, VAT reinstatement response, lower VAT cadence, additional company-tax information request/response, Andrei 2024/2025 evidence split cleanup, billing mechanics from 2025 onward, official personal/director address confirmation, and 2025 personal-tax setup.
