...
- 2026-05-25 annual VAT status: after user approval, AGL 2024 Umsatzsteuererklaerung was submitted in Mein ELSTER with EUR 0.00 final VAT/refund. ELSTER Transferticket `ep1454t90i8mmb5zp5wtk182ewbfh5wq`, submitted 2026-05-25 at 23:01:09 for Ordnungskriterium `29/628/00250`. The user-saved ELSTER return/review PDF was uploaded to Drive at `https://drive.google.com/file/d/1aFHjF8spGtE1g_tYavgmG2rO9-jYsTP2/view?usp=drivesdk` and recorded in Notion comments `36be4130-1314-81ca-9006-001dfcf9a622` and `36be4130-1314-81d9-b2eb-001d8a850ea2`. The four incoming May 2026 Finanzamt letters/scans and Q1-Q4 2024 UStVA protocols were also uploaded to AGL Drive and indexed in `clients/Companies/AGL/drive-locations.md`. Local USt Bescheid `Agile Lincs 2024.pdf` dated 2026-03-23 assessed EUR 5,200.00 VAT plus EUR 75.00 Verspaetungszuschlag and likely explains the VAT component of the Mahnung; next step is a reviewed Finanzamt message requesting processing/amendment and collection pause while the E-Bilanz dataset is completed.
