...
| `ioana-richmond-blackwood` | `ioana@richmondblackwood.com` | Human operator RB Google route | configured and verified 2026-06-02 | User approved the exact account and OAuth reconnect on 2026-06-02. Do not infer source/sender/auth from `RB_CODEX_ACTOR`; scope it explicitly. |
