...
| 2026-05-05 | `rb-gmail-drafts` | Port neutral operating infrastructure | Added verified RB accounting sender draft helper. | Added Gmail draft, delete, and keychain helper scripts defaulting to `accounting@richmondblackwood.com`. | Gmail helper `--help` smoke check passed; live Gmail verification was not run. |
