...
| Monitor HardSoft Mac quote follow-up call `RBCALL-43`, now reset to `Reviewed`/approved after correcting HardSoft hours to Monday-Friday 09:00-17:30 Europe/Dublin, and update the EIP computer-order trail once HardSoft confirms the right order email/contact and quote process. | 2026-06-08 |
