...
- Decisions made: Treat the user instruction that 2024/2025 company taxes were filed as provisional pending final source evidence, because Notion confirms filing/upload work but still references electronic balance-sheet follow-up. Treat VAT appeal submission as complete but Finanzamt response pending. Treat Andrei's 2024 personal tax as free and 2025 onward as billable at normal fee.
- Verification: Source connector reads completed; no live Notion/Drive/Gmail/WhatsApp records were modified.
- Limitations or gaps: Finanzamt prepayment notices/amounts, VAT reinstatement response, lower VAT cadence, final company-tax closeout/e-balance evidence, Andrei evidence split, spouse/joint filing evidence, TK/private-insurance final treatment, and NACV payslip/wage-tax extraction remain open.
