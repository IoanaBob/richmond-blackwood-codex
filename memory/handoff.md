...
RB calling bot setup and live-runtime sync are now source-controlled. Use `setup/mcp/elevenlabs-n8n.md`, `automation/README.md`, and `automation/live-readbacks/rb-calls-live-state.json` before changing n8n or ElevenLabs. The 2026-05-13 readback shows `RB Calls Voice Execution` active at `c7d84f52-ae58-4073-889f-89eb2000a937`, `RB Calls Live Help` at `9d2ea23e-ffaa-451e-b98a-8628fa9a9ac1`, `RB Calls ElevenLabs Events` active at `29dc070e-2951-4f7f-931b-6b24ea793fc5` with draft `48d12009-db89-4c75-8df1-6e48564f12ed`, `RB Calls Context Lookup` at `b8b439eb-0587-4600-a93a-89a27ca2e8fc`, and ElevenLabs `RB Call Bot` at `agtvrsn_9501krh4qjm7e6n9jy079k5tgea5`. Run `npm run calls:sync-live-state` after manual UI edits. Do not commit tokens, phone numbers, transcripts, recordings, or client call payloads.
